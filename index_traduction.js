...
(function() {
    ...
    const translations = {
        ...
        ht: {
            ...
            "hero.title": "Fason ki pi vit, pi an sekirize ak pi ekonomik pou voye rechaj telefòn bay fanmi ak zanmi ou, nan plis pase 150 peyi yon fason <span>vit e sekirize</span>",
            "hero.subtitle": "Avèk Intop, ou voye rechaj bay fanmi ak zanmi nan lòt peyi yon fason senp e rapid. Chwazi peyi a, Chwazi operate a, antre nimewo a, cantre kantikob ou vle voye a, epi peye atravè Pix.",
            "hero.country_operator": "PEYI AK OPERATÈ",
            "hero.download_google": "Telechaje sou",
            "cta.title": "Èske w pare pou rechaje?",
            "cta.subtitle": "Enstale aplikasyon ofisyèl Intop l sou Android ou epi w ap gen aksè a rechaj otomatik nan men ou.",
            "cta.download_direct": "Telechaje Dirèk",
